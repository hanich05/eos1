...
kernel/full_kernel.bin: kernel/kernel.o kernel/kernel_entry.o kernel/text_mode.o libc/memmove.o libc/memset.o
	i386-elf-ld -Ttext 0x1000 "kernel/kernel_entry.o" "kernel/kernel.o" "kernel/text_mode.o" "libc/memmove.o" "libc/memset.o" --oformat binary -o "kernel/full_kernel.bin"
...
kernel/text_mode.o: kernel/text_mode.c libc/memmove.h libc/memmove.h
	i386-elf-gcc -ffreestanding -m32 -g -c "kernel/text_mode.c" -o "kernel/text_mode.o"
...
clean:
	rm -f "boot/boot.bin" "fkernel/ull_kernel.bin" "kernel/kernel_entry.o" "kernel/kernel.o" "libc/memmove.o"